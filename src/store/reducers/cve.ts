import { CveState, CveActionTypes, SET_CVE_LIST, SET_CUR_CVE, SET_CVE_INIT_LOADING } from "../types/cve";
...
export const cveReducer = (state = initialState, action: CveActionTypes): CveState => {
  console.log("cveReducer state change", state, action);
  switch (action.type) {
    case SET_CVE_LIST:
